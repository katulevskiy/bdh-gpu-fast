...
| Attn-bwd-v4 #198 (current tip) | **Landed** `9ad9015` — CPU-only T=1 strict-tril backward contract coverage across eager, blocked, online, Triton-fallback, and CUDA-reference dispatch for shared-V and full-head-V layouts; no GPU timing or speedup claim
