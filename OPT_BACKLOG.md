...
| CUDA missing-nvcc skip deepen (current tip) | **Landed** at `d6a5455` — a directory named `nvcc` remains a clear CPU-safe no-op before CUDAExtension setup; no GPU build or timing claim
