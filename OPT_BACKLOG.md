...
| Current tip | **Landed** at `6d6aaab` — profile-v20 counts remain 2/12/394 with `cat=0` and `contiguous=0`; #262–#265 add CPU/docs contracts only, and the real-GPU P0 blocker remains open
