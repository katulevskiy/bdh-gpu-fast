...
| CUDA build v3 #196 (current tip) | **Landed** `4e9d3e4` — CPU-safe missing-nvcc setup discovery across CUDA_HOME/CUDA_PATH/PATH with explicit setup smoke; no GPU build or timing claim
