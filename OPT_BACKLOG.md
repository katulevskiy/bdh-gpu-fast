...
(`torch 2.14.0+cu130`, `cuda=False`), profile tip `b126d77` / documented tip `ca5038f` (post #64–#66; #67–#75 as before; #76 docs matrix through #75; #77 auto-tune cold thr), cfg `layers=4 d=128 nh=4 B=4 T=128`,
