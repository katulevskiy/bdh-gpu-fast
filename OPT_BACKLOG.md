...
(`torch 2.14.0+cu130`, `cuda=False`), profile tip `c7a7471` / documented tip `b19ec59` (post #48–#51; includes `opt/profile-v4` and `opt/ln-deepen`), cfg `layers=4 d=128 nh=4 B=4 T=128`,
