# OPT status — landed work (#1–#632; docs-v91)
...
The retained profile-v20 baseline is `aten::copy_` 2/call for attention, 12/call for forward, and 394/call for generate, with `aten::cat=0` and `aten::contiguous=0`. The #403–#583, #589–#605, #607–#616, and #622–#632 additions are CPU-safe contracts, diagnostics, and docs; #450/#465/#479/#495/#512/#525/#540/#603/#616/#632 refine CUDA-build/device/runtime skip handoffs, exact build-flag handling, schema-v10 requested-config retention, stdout/JSON parity, preserved device, availability-probe, and build-probe errors, and no-timing boundaries, while #552/#566/#582/#598/#611/#626 harden explicit CPU extension selection and #579 labels the CPU CUDA benchmark fallback. None adds CUDA timing, GPU throughput, sparse-kernel evidence, or cold CUDA–Triton validation. These are CPU call-count observations, not GPU performance claims.
